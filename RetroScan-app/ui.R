...
shinyUI(navbarPage(title = img(src="title_retro.png", height = "40px"), id = "navBar",
                   ...
                   tabPanel("HOME", value = "home",
                            ...
                            fluidRow(
                                HTML("
                                     ...
                                     <p class='parallax_description'>An easy-to-use pipeline for retrocopy annotation and visualization.</p>
                                     </section>
                                     ")
                                ),
                            ...
                            fluidRow(
                              ...
                              column(4,align = "center", 
                                     ...
                                     h5(checkboxInput(inputId = "loadExamplebtn",label = strong("Load Example Data"),value = FALSE,width='100%')),
                                     actionButton('loadexample', 'Start import process',
                   ...
                   tabPanel("UPLOAD", value = "uploadPF",

                                       shiny::HTML("<br><br>"),
                                       fluidRow(
                                         column(2),
                                         column(9,
                                                shiny::HTML("<h5 style='line-height:30px'>These three files are necessary and can be found in 
                                       ...
                                       fluidRow(
                                         column(2),
                                         column(9,
                                                shiny::HTML("<h5 style='line-height:30px'>If you provide RNASeq data and get the FPKM values, 
                            ...
                            fluidRow(
                              column(2),
                              column(3,
                                     actionButton('reset', 'Reset opload data')    
                              ),
                              column(3,
                                     tags$a('Start analysis',
                                         onclick="fakeClick('careerPF')", 
                                         class="btn btn-primary btn-lg")),
                              column(4)
                            )),
                   ...
                   tabPanel("RETROSCAN", value = "careerPF",
                            tabsetPanel(
                              type = "tabs",
                                #summary
                                tabPanel("summary",value = "summaryPF",
                                        fluidRow( 
                   ...
                   tabPanel("ABOUT", value = "about",
                            ...
                            fluidRow(
                                ...
                                column(8,
                                       tags$p(
                                           shiny::HTML("<h6 style='line-height:25px'>RetroScan: an easy-to-use pipeline 
